...
int nAnonymizeChainAidAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\ChainAid
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\ChainAid
    // Mac: ~/Library/Application Support/ChainAid
    // Unix: ~/.ChainAid
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "ChainAid";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "chainaid.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "chainaidd.pid"));
