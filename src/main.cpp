...
int nCoinbaseMaturity = 80; // 80 Confirmations
...
const string strMessageMagic = "ChainAid Signed Message:\n";
...
static int64_t nTargetTimespan = 20 * 60;  // 60 minutes for the timespan to adjust
...
{
    int64_t ret =  blockValue * 3/5; // the value = 300 CHID 
    return ret;
}
